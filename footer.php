<div class="footer-section">
    <div class="container">
<div class="safari">
<img src="<?php bloginfo('template_url'); ?>/assets/images/vc-1.png">
</div>
<div class="info-type">
    <div class="row">
        <div class="col-lg-4">
        ...
        <div class="unit">
        <li>Unit 3.15</li>
        <li>Barking Enterprise centre</li>
        <li>50 Cambridge Road Barking</li>
        <li>London 1G11 8FG</li>
        </div>
        </div>
    </div>
</div>
<div class="privacy-policy">
    <div class="row">
        <div class="col-lg-4">
            <div class="terms">
                <h5><a href="">Terms of Use </a> and <a href="">Privacy Policy</a></h5>
            </div>
        </div>
        <div class="col-lg-8">
            <div class="follow">
